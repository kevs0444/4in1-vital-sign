...
import { Logout, Person, Visibility, Settings, History, Check, Close, ErrorOutline, WarningAmber, Dashboard } from '@mui/icons-material';
...
const EmployeeDashboard = () => {
    ...
    // Filter history by time period (used for Analytics? Yes)
    // Does MyMeasurements use it? No, it handles its own.
    // DashboardAnalytics uses these.
