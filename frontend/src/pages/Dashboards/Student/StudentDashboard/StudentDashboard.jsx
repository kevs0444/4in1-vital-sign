            ...
            <div className="dashboard-content">
                ...
                >
                    ...
                    <div className="summary-card">
                        <h3>Latest Status</h3>
                        <div className="summary-value" style={{ fontSize: '1.5rem', color: '#f59e0b' }}>
                ...
                <div className="modal-overlay" onClick={() => setSelectedMeasurement(null)}>
                    ...
                    >
                        ...
                        <div style={{ marginBottom: '24px' }}>
                            ...
                            {/* Since we don't have full recs in history list, we show generic or risk based message for now */}
