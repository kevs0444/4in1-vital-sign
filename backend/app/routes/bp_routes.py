...
def start_bp_camera():
    ...
    mode = data.get('mode', 'regular') # Default to regular
    
    success, message = bp_sensor.start(camera_index=camera_index, camera_name=camera_name, enable_ai=enable_ai, mode=mode)
