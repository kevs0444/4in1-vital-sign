    ...
    <div className="result-container">
      <div className={`result-content ${isVisible ? 'visible' : ''}`}>
        ...
        <div className="result-header">
          <h1 className="result-title">AI Health Assessment Results</h1>
          <p className="result-subtitle">
            Powered by VitalSign AI Analysis Engine
          </p>
        </div>
            ...
            <div className="patient-summary">
              ...
              <div className="summary-grid">
                ...
                <div className="summary-item">
                  ...
                  <span className="value">{userData.sex === 'male' ? 'Male' : 'Female'}</span>
                </div>
              </div>
            </div>
              ...
              <div className="vitals-grid">
                <div className="vital-card">
                  ...
                  <div className="vital-info">
                    <h3>BMI</h3>
                    <span className="vital-value">{calculateBMI(userData)}</span>
                ...
                <div className="vital-card">
                  ...
                  <div className="vital-info">
                    <h3>Temperature</h3>
                    <span className="vital-value">{userData.bodyTemp}</span>
                ...
                <div className="vital-card">
                  ...
                  <div className="vital-info">
                    <h3>Heart Rate</h3>
                    <span className="vital-value">{userData.heartRate}</span>
                ...
                <div className="vital-card">
                  ...
                  <div className="vital-info">
                    ...
                    <span className="vital-value">{userData.respiratoryRate}</span>
